...
G4VPhysicalVolume* DetectorConstruction::Construct() {
    ...
    fLogicalVoxel10 = new G4LogicalVolume(solidVoxel10, mediumVoxel10, "fLogicalVoxel10");
    new G4PVPlacement(
        pRot,
        tlate_Voxel10,
        fLogicalVoxel10,
...
void DetectorConstruction::ConstructSDandField() {
    ...
    G4MultiFunctionalDetector *detectorVoxel10 = new G4MultiFunctionalDetector("voxel10");
    G4VPrimitiveScorer* psDoseVoxel10 = new G4PSDoseDeposit("dose");
    detectorVoxel10->RegisterPrimitive(psDoseVoxel10);
    SetSensitiveDetector(fLogicalVoxel10, detectorVoxel10);
    sdManager->AddNewDetector(detectorVoxel10);

    G4MultiFunctionalDetector *detectorVoxel20 = new G4MultiFunctionalDetector("voxel20");
    G4VPrimitiveScorer* psDoseVoxel20 = new G4PSDoseDeposit("dose");
    detectorVoxel20->RegisterPrimitive(psDoseVoxel20);
    SetSensitiveDetector(fLogicalVoxel20, detectorVoxel20);
    sdManager->AddNewDetector(detectorVoxel20);
